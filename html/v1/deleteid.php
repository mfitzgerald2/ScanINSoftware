...
$sql = "DELETE FROM attendance WHERE number='$ID'";

if ($conn->query($sql) === TRUE) {
	echo $ID;
	echo " was deleted successfully.";
	echo '<br>';
    	echo 'Your command was sent.';
	} 
else {
...
?>
          ...
          <div class="content_item">
        <p>The above table is a table of when students were scanned in the morning. Students are arranged alphabetically.</p>          
