...
?>
		...
		First Name: <input type="text" name="firstname" value="<?php echo htmlspecialchars($firstname); ?>"><br><br><br><br>
		<select name="option">
		...
		<option value="grade">Grade</option>
  		<br><br>
		Modified Data: <input type="text" name="input" value="<?php echo htmlspecialchars($value); ?>"><br><br>
		<input type="submit">
		<input type="submit" formaction="editrfidnum.php" value="Refresh RFID Number">
	    </form>
	</div><!--close sidebar_item--> 
