...
$value = $_POST['grade'];
$sql="Select Class, grade,RFID,LastName, FirstName,id, Count(AtRFID),already From students LEFT JOIN attendance ON attendance.AtRFID=students.RFID WHERE grade='$value' GROUP BY id ORDER BY LastName;";
...
<td colspan="8" align="center" bgcolor="#FFFFFF"><strong>All Currently Participating Students</strong> </td>           </tr>
...
<input name="checkbox[]" type="checkbox" id="checkbox[]" value="<?php echo $rows['RFID']; ?>">
</td><td bgcolor="#FFFFFF"><?php echo $rows['LastName']; ?>
</td><td bgcolor="#FFFFFF"><?php echo $rows['FirstName']; ?>
</td><td bgcolor="#FFFFFF"><?php echo $rows['Count(AtRFID)']; ?> 
</td><td bgcolor="#FFFFFF"><?php echo $rows['Class']; ?>    
</td><td bgcolor="#FFFFFF"><?php echo $rows['grade']; ?>
</td><td bgcolor="#FFFFFF"><?php echo $rows['RFID']; ?>
</td><td bgcolor="#FFFFFF"><?php echo $rows['already']; ?>
</td></tr>
<?php } ?>
...
if($result){echo "<meta http-equiv=\"refresh\" content=\"0;URL=viewdatabase.php\">";}}
mysql_close();
?>
...
<p>Student count: <?php echo number_format($count) ?></p>
          ...
          <div class="content_item">
        <p>The Safe Routes to School RFID system was developed by students from Purdue University through the Engineering Projects in Community Service (EPICS) program. To read more about the group who developed this system and Edit Students information, click on the link below. </p>          
        <div class="button_small">
          <a href="http://epics.ecn.purdue.edu/srts/">Read more</a>
