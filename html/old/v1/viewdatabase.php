...
<div class="sidebar">
	...
	<div class="button_small">
		      <a href="exceldownload.php">Download Excel File</a>
...
$sql="Select Class, grade,RFID,LastName, FirstName,id, Count(AtRFID),already From students LEFT JOIN attendance ON attendance.AtRFID=students.RFID GROUP BY id ORDER BY LastName;";
...
<p>Student count: <?php echo number_format($count) ?></p>
          ...
          <div class="content_item">
        <p>The above table is a complete view of the database. Students are arranged alphabetically.</p>          
