...
$sql = "UPDATE students SET $option='$input' WHERE LastName='$lastname' AND FirstName='$firstname'";
...
$sql = "SELECT * FROM students WHERE LastName= '$lastname'OR LastName= '$input' AND FirstName= '$firstname' OR FirstName= '$input'";
...
if ($result->num_rows > 0) {
    ...
    echo "NOTE: It looks like this student has not yet been added to the database or the student's name was misspelled.";
}
$conn->close();
?>
